    ...
    <>
      <div className="h-[72px]  w-full bg-[#F7F7F7] border-b-[1px] border-b-[#676767] flex justify-between max-[656px]:justify-center items-center">
        <div className="w-[130.6px] max-[656px]:w-[1040px] h-[41px] flex justify-between item-center max-[756px]:ml-[1rem] ml-[3rem]">
          ...
          />
          <IoIosMenu className="hidden mt-2 mr-3 max-[656px]:block w-[35px] h-[30px]" onClick={toggleMenu}/>
        <ul className={`${isMenuOpen ? "block" : "hidden"} w-full h-[400px] flex flex-col items-center bg-gray-200 absolute mt-[3rem] left-0`}>
          <li className="text-[22px] mt-10 mb-4 text-white">Home</li>
          <li className="text-[22px] my-4 text-white">Courses</li>
          <li className="text-[22px] my-4 text-white">Service</li>
          <li className="text-[22px] my-4 text-white">Achivement</li>
          <li className="text-[22px] my-4 text-white">About Us</li>
        </ul>
